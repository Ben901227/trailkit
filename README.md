...
- [x] 內建臺灣山頭 3,669 座，預設顯示、可開關，離線也能用
- [x] 內建 27 個常用圖層，不必先匯入 KML：魯地圖系列與林班界，
      以及中研院百年歷史地圖全套 21 張圖幅（1899–2003）
...
- [x] 自訂圖片疊圖：四角自由校正、整張拖曳，匯出 KMZ 時圖片一併打包
      （**預設關閉**，在「圖層」面板開啟；關閉時拖進來的圖片會被忽略，
      檔案內的 GroundOverlay 仍會保留與匯出，只是不畫出來）
...
比例尺旁的羅盤標示 N/E/S/W 並跟著視角轉動，點一下轉回正北。
