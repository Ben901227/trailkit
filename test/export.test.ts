...
const state: AppState = { docs: [doc], selection: null, basemapId: 'osm', customBasemapUrl: null, layers: [], editing: false, terrain: false, showWaypoints: true, showWaypointLabels: true, imageOverlays: false, showPeaks: false, vertex: null }
...
describe('buildExport', () => {
  ...
  it('refuses to build an empty export', async () => {
    const empty: AppState = { docs: [], selection: null, basemapId: 'osm', customBasemapUrl: null, layers: [], editing: false, terrain: false, showWaypoints: true, showWaypointLabels: true, imageOverlays: false, showPeaks: false, vertex: null }
